package kl.example.com.imageslector.adapter;
...
import kl.example.com.imageslector.*;
...
public class GridImageAdapter extends
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        if (getItemViewType(position) == TYPE_CAMERA) {
            ...
            viewHolder.ll_ok.setVisibility(View.INVISIBLE);
        } else {
            viewHolder.ll_ok.setVisibility(View.VISIBLE);
            viewHolder.ll_ok.setOnClickListener(new View.OnClickListener() {
                @Override
