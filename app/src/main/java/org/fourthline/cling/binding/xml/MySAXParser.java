...
import org.seamless.xml.CatalogResourceResolver;
...
public class MySAXParser {
	 	final private static Logger log = Logger.getLogger(MySAXParser.class.getName());
		...
		public MySAXParser(DefaultHandler handler) {
	        this.xr = create();
	        if (handler != null)
...
//	            factory.setXIncludeAware(false);
	    ...
	    public static class Handler<I> extends DefaultHandler {
	        ...
	        public Handler(I instance, MySAXParser parser) {
	        ...
	        public Handler(I instance, MySAXParser parser, Handler parent) {
