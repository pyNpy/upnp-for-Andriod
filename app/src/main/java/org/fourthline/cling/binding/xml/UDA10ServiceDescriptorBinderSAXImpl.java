...
public class UDA10ServiceDescriptorBinderSAXImpl extends UDA10ServiceDescriptorBinderImpl {
    ...
    protected static class RootHandler extends ServiceDescriptorHandler<MutableService> {
        ...
        public RootHandler(MutableService instance, MySAXParser parser) {
    ...
    */
    ...
    protected static class ServiceDescriptorHandler<I> extends MySAXParser.Handler<I> {

        public ServiceDescriptorHandler(I instance) {
            super(instance);
        }

        public ServiceDescriptorHandler(I instance, MySAXParser parser) {
            super(instance, parser);
        }
        ...
        public ServiceDescriptorHandler(I instance, MySAXParser parser, ServiceDescriptorHandler parent) {
