...
public class USNRootDeviceHeader extends UpnpHeader<UDN> {
	...
	/***
	 *	 ROOT_DEVICE_SUFFIX = "::upnp:rootdevice
     *	*/
	@Default 
    ...
    public void setString(String s) throws InvalidHeaderException {
    	org.fourthline.cling.android.AndroidLog.log("run:: "+USNRootDeviceHeader.class.getName());
    	org.fourthline.cling.android.AndroidLog.log(s);
