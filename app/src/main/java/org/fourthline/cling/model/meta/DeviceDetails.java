...
public class DeviceDetails implements Validatable {
	...
	public String toString() {
		return "DeviceDetails [baseURL=" + baseURL + ", friendlyName=" + friendlyName + ", manufacturerDetails="
				+ manufacturerDetails + ", modelDetails=" + modelDetails + ", serialNumber=" + serialNumber + ", upc="
				+ upc + ", presentationURI=" + presentationURI + ", dlnaDocs=" + Arrays.toString(dlnaDocs)
				+ ", dlnaCaps=" + dlnaCaps + ", secProductCaps=" + secProductCaps + "]";
	}
