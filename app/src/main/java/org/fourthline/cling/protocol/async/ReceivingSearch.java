...
public class ReceivingSearch extends ReceivingAsync<IncomingSearchRequest> {
    ...
    protected void execute() throws RouterException {
    	...
    	AndroidLog.log("run:: "+this.getClass().getName() +".execute" );
        ...
        if (!getInputMessage().isMANSSDPDiscover()) {
            ...
            AndroidLog.log("Invalid search request, no or invalid MAN ssdp:discover header: " + getInputMessage() );
            return;
        }
        ...
        for (NetworkAddress activeStreamServer : activeStreamServers) {
        	AndroidLog.log("activeStreamServer:"+activeStreamServer.getAddress().getHostAddress());
